<%-- 
    Document   : bmw
    Created on : Jul 13, 2019, 12:46:50 AM
    Author     : ASUS
--%>
...
<div class="content" style="width: 1500px; height: 500px; position: absolute; overflow: hidden; background-color: black; margin-left: 0px; margin-top: 150px; z-index: -1">
                 <img src="ImageGallery/contentFiles/bmw1.png">
                 <img src="ImageGallery/contentFiles/bmw2.png">
                 <img src="ImageGallery/contentFiles/bmwb3.jpg">
                 <img src="ImageGallery/contentFiles/bmw4.jpg">
                 <img src="ImageGallery/contentFiles/bmw5.jpg">
                 <img src="ImageGallery/contentFiles/bmw6.jpg">
                 <img src="ImageGallery/contentFiles/bmw7.jpg">
               </div>
...
<div class="ftr">
<h3>BMW AG originally an initialism for Bayerische Motoren Werke in German, or Bavarian Motor Works in English) is a German multinational company which currently produces automobiles and motorcycles, and also produced aircraft engines until 1945. The company was founded in 1916 and is headquartered in Munich, Bavaria. BMW produces motor vehicles in Germany, Brazil, China, India, South Africa, the United Kingdom, and the United States. In 2015, BMW was the world's twelfth largest producer of motor vehicles, with 2,279,503 vehicles produced. The Quandt family are long-term shareholders of the company, with the remaining shares owned by public float.</h3>
</div>
</body>
</html>