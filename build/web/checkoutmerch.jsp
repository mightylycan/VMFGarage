    ...
    <div class="container">
      ...
      <div class="row">
          <div class="col-50">
			...
			<optgroup label="Jacket">
				<option value="Lamborghini Bomber Jacquard Jacket">Lamborghini Bomber Jacquard Jacket</option>
				<option value="Lamborghini Leather Jacket">Lamborghini Leather Jacket</option>
				<option value="Ferrari Men's Bomber Jacket">Ferrari Men's Bomber Jacket</option>
				<option value="Ferrari Men's Jacket in T2 Tech-Will">Ferrari Men's Jacket in T2 Tech-Will</option>
			</optgroup>
			<optgroup label="Cap">
				<option value="Lamborghini Basic Shield Cap">Lamborghini Basic Shield Cap</option>
				<option value="Bull LXII Cap">Bull LXII Cap</option>
				<option value="Ferrari Everywhere Red Men's Cap">Ferrari Everywhere Red Men's Cap</option>
                                <option value="Ferrari Men's Cap with Red Clouds Print">Ferrari Men's Cap with Red Clouds Print</option>
			</optgroup>
			<optgroup label="T-Shirt & Poloshirt">
				<option value="Lamborghini Metalic Shield T-Shirt">Lamborghini Metalic Shield T-Shirt</option>
				<option value="Lamborghini Hi-Tech Polo Shirt">Lamborghini Hi-Tech Polo Shirt</option>
				<option value="Ferrari Men's Jacquard Jersey Polo Shirt with Zip">Ferrari Men's Jacquard Jersey Polo Shirt with Zip</option>
                                <option value="Ferrari Men's T-Shirt in Technical Fabric with Print">Ferrari Men's T-Shirt in Technical Fabric with Print</option>
			</optgroup>
		</select></td>
                  </table>
              </div>
        ...
        <button class="w3-button w3-black w3-round-xxlarge"><a href="merch.jsp" style="text-decoration: none;">Back To Store</a></button>
        </form>
    </div>
