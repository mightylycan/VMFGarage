<%-- 
    Document   : profile
    Created on : Jul 13, 2019, 1:59:22 AM
    Author     : ASUS
--%>
...
<a style="font-family: 'Racing Sans One'" class="signup" href="signup.jsp">Sign Up</a>
</div>
<div class="content">
	<h3>The VMF garage is a car dealer that was founded in 1999, with Alvido the person behind it all. Alvido has a vision that he can sell cars at a cheaper price than the price of the car the company sold, by guaranteeing high sales figures for the sports car company that will be sold again. VMF garage is arguably the second hand or distributor of reliable sports car sales with good quality. Regardless of all that, finally the garage is growing big and has branches in 3 cities;<br> Jakarta, Bandung and Yogyakarta.</h3>
	<hr>
	<h4>Copyright 2019</h4>
<img style="width: 150px; height: 70px; margin-left: 100px; margin-top: 30px;" src="Ferrarilogo.png">
<img style="width: 150px; height: 70px; margin-left: 430px; margin-top: 30px;" src="lamborghinilogo.png">
<img style="width: 100px; height: 70px; margin-left: 450px; margin-top: 30px; position: absolute;" src="bmwlogo.png">
</div>
</body>
</html>
